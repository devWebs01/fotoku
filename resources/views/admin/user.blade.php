                                    ...
                                    <tbody>
                                        @foreach ($data as $i)
                                            <tr>
                                                ...
                                                <td>
                                                    @isset($i->tatanan_id)
                                                        {{ $i->tatanan->nm_tatanan }} 
                                                    @endisset 
                                                </td>
                                                <td>{{ $i->updated_at }}</td>
                                            @canany(['update user', 'delete user'])
                                                    <td>
                                                        {{-- @if(in_array('admin', $i->getRoleNames()->toArray()))
                                                        <div class="btn-group">
                                                            @can('update user')
            ...
            $(document).on("click", '.btn-edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#modal-edit #tatanan_id").val(data.tatanan_id).trigger('change');
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.user.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <label>Tatanan</label>
                            <div class="input-group">
                                <select class="form-control" name="tatanan_id" id="tatanan_id">
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.user.destroy') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
