			...
			<div class="row">
				...
				<div class="col-sm-5 col-lg-4">
					<div class="search_main">
						<div class="left_main">
							<div class="login_text"><a href="{{ url('/') }}#register">Register Pengguna</a></div>
						</div>
                ...
                <div class="col-6">
                    <center>
                        <div class="box-profile">
                            <img class="profile-user-img img-fluid img-circle img-fotografer" style="width: 300px;height: 300px;" src="{{ asset('user-default.jpg') }}" alt="User profile picture">
            ...
            if($(this).val() != ''){
                ...
                $.get("{{ url('admin/fotografer/getFotograferFromKecamatan')}}/"+ id, function(response){
                    $.each(response.data, function (key, data) {
                        $('#fotografer_id').append('<option data-name="'+data.nama+'" value="'+data.id+'">'+data.nama+'</option>');
                    })
                });
            }else if($(this).val() == ''){
