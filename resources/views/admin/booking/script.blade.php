    ...
    $(function () {
      let table = $("#Booking").DataTable({
        ...
        $('body').on('click', '.btnDelete', function () {
            id = $(this).data("id");    
            nama = $(this).data("nama");  
            alertify.confirm('<i class="fa fa-exclamation-triangle mr-2" aria-hidden="true" id="hapus"></i> KONFIRMASI BATAL', '<h4>Apakah Anda Yakin BATALKAN Pemesanan : '+nama+' ?</h4>', function(){ 
