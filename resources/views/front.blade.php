...
<body>
		...
		<div class="container-fluid">
			<div class="row ">
				<div class="col-8 col-sm-3">
					<div class="logo"><a href="{{ url('/') }}"><img src="{{ asset('logo-header.jpg') }}" width="150px;"></a></div>
                    ...
                    <div class="collapse navbar-collapse float-right" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                        	<ul>
                                ...
                                <li>|</li>
                                <li><a class="nav-item nav-link" href="{{ url('/') }}#about">Tentang Kami</a></li>
                                <li>|</li>
                                <li><a class="nav-item nav-link" href="{{ url('fotografer') }}">Fotografer</a></li>
                                <li>|</li>
                                <li><a class="nav-item nav-link" href="{{ url('/') }}#register">Register Pengguna</a></li>
                                <li>|</li>
			...
			<section class="slide-wrapper">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row">
				            <div class="col-md-7">
					            <div class="images_1"><img src="{{ asset('frontend/images/banner-bg.png') }}"></div>
				            ...
				            <div class="col-md-5">
					            <div class="images_2"><img src="{{ asset('frontend/images/img-12.jpg') }}"></div>
				            </div>
			            </div>
                </div>
                <div class="carousel-item">
                   <div class="row">
				       <div class="col-md-7">
					       <div class="images_1"><img src="{{ asset('frontend/images/banner-bg2.png') }}"></div>
				        	<div class="banner_main">
								<div class="red_bt">
									&nbsp;
									{{-- <a href="#">Selengkapnya</a> --}}
				        ...
				        <div class="col-md-5">
					        <div class="images_2"><img src="{{ asset('frontend/images/img-4.png') }}"></div>
				        </div>
			        </div>
                </div>
                <div class="carousel-item">
                   <div class="row">
				       <div class="col-md-7">
					       <div class="images_1"><img src="{{ asset('frontend/images/banner-bg3.png') }}"></div>
				        	<div class="banner_main">
								<div class="red_bt">
									&nbsp;
									{{-- <a href="#">Selengkapnya</a> --}}
				        ...
				        <div class="col-md-5">
					        <div class="images_2"><img src="{{ asset('frontend/images/img-13.jpg') }}"></div>
				        </div>
			        </div>
                </div>
                <div class="carousel-item">
                   <div class="row">
				       <div class="col-md-7">
				        ...
				        <div class="col-md-5">
					        <div class="images_2"><img src="{{ asset('frontend/images/img-1.png') }}"></div>
				        </div>
			        </div>
                </div>
            </div>
						...
						<div class="card card-primary card-outline">
							<div class="card-body box-profile">
								...
								<ul class="list-group list-group-unbordered mb-3">
									...
									<li class="list-group-item">
									<b>Kecamatan</b> <a class="float-right">{{ $item->kecamatan?->nama_kecamatan }}</a>
									</li>
								</ul>
								<a href="{{ url('fotografer_detail/'.$item->id) }}" class="btn btn-primary btn-block "><b>Detail</b></a>
								<button class="btn btn-success btn-block whatsapp-button" id="whatsapp-button" data-hp="{{ $item->no_telp }}"><b>Whatsapp</b></button>
							</div>
						</div>
					</div>
				@endforeach
			</div>
			<div class="send_text" style="margin-top: 50px;"><a href="{{ route('fotografer_depan') }}">Selengkapnya</a></div>
		</div>
	</div>
	<!-- profile section end -->
    ...
    <div class="carousel-item active">
      <div class="row">
					<div class="col-md-6">
						...
						<p class="lorem_ipsum_text">Kami juga menawarkan paket yang dapat disesuaikan dengan kebutuhan Anda. Segera hubungi kami untuk mengabadikan momen sebelum pernikahan Anda dalam foto prewedding yang menakjubkan.</p>
						
					</div>
					<div class="col-md-6">
						<p class="ipsum_text">Nikmati pengalaman prewedding studio indoor yang mengesankan dengan penawaran kami. Studio kami dilengkapi dengan peralatan modern dan berbagai latar belakang menarik untuk menciptakan suasana yang nyaman dan intim. Dengan bantuan fotografer profesional, Anda akan mendapatkan hasil foto prewedding yang indah dan berkesan.</p>
						<div class="images_3"><img src="{{ asset('frontend/images/img-3.png') }}"></div>
						<div class="taital_main">
							<h2 class="camera_text">Prewedding Studio Indoor</h2>
							<h2 class="dolar_text_2">Rp. <span style="color: #874ce0;">1.000.000</span></h2>
						</div>
					</div>
				</div>
    </div>
    <div class="carousel-item">
      <div class="row">
					<div class="col-md-6">
						...
						<p class="lorem_ipsum_text">Dapatkan layanan fotografi terbaik untuk aqiqah dan pesta ulang tahun Anda. Tim kami akan hadir untuk menangkap momen berharga dalam acara tersebut, menciptakan foto-foto yang indah dan penuh emosi. Dengan paket yang dapat disesuaikan, Anda dapat memilih durasi pemotretan dan gaya fotografi yang sesuai dengan keinginan Anda. Jangan lewatkan kesempatan ini untuk mengabadikan momen berharga Anda dalam foto-foto yang berkesan. Segera hubungi kami dan dapatkan penawaran khusus untuk memastikan kenangan tak terlupakan dalam aqiqah dan pesta ulang tahun Anda.</p>
					</div>
					<div class="col-md-6">
						<p class="ipsum_text">Nikmati momen berharga dalam perayaan aqiqah dan pesta ulang tahun dengan penawaran kami. Tim fotografer profesional kami akan mengabadikan setiap detail dari persiapan hingga acara utama, menghasilkan foto-foto indah yang akan menjadi kenangan abadi. Kami menawarkan paket yang dapat disesuaikan sesuai dengan kebutuhan Anda, memastikan pengalaman fotografi yang tak terlupakan. Hubungi kami sekarang untuk penawaran khusus dan jadikan momen aqiqah dan pesta ulang tahun Anda lebih berarti melalui foto-foto yang istimewa.</p>
    ...
    <div class="carousel-item">
      <div class="row">
					<div class="col-md-6">
						...
						<p class="lorem_ipsum_text">Kami juga menawarkan paket yang dapat disesuaikan dengan kebutuhan dan preferensi Anda. Dari pemilihan lokasi, gaya fotografi, hingga pengeditan foto profesional, kami akan bekerja sama dengan Anda untuk memastikan bahwa setiap momen penting terabadikan dengan sempurna. </p>
					</div>
					<div class="col-md-6">
						<p class="ipsum_text">Kami dengan senang hati mempersembahkan penawaran foto pertunangan yang akan mengabadikan momen indah dalam perjalanan menuju pernikahan Anda. Kami menawarkan jasa fotografi profesional untuk membuat kenangan yang tak terlupakan dari momen bersejarah ini.
						</p>
						<p>Dalam penawaran ini, tim fotografer kami akan hadir dalam acara pertunangan Anda, menangkap momen-momen istimewa, tawa, dan kebahagiaan. Kami akan menciptakan foto-foto yang indah dan autentik yang akan menjadi kenangan berharga sepanjang hidup.</p>
  ...
  <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
	...
	<div class="contact_section layout_padding" id="register">
		<div class="container">
			<form method="POST" id="form-daftar" action="{{ route('daftar') }}" accept-charset="UTF-8" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="mail_section">
				<div class="row">
					...
					<div class="col-md-6">
						<input type="number" class="input_text" placeholder="No Telephone..." name="no_telp" required>
						<input type="password" class="input_text" placeholder="Password" name="password" required>
					</div>
					<div class="col-md-6">
						<div class="form-check" style="color: white; margin-bottom: 20px; font-size: 16px!important;">
							<h2 style="margin-left: -20px; margin-bottom: -35px; color: white;">
								Daftar Sebagai :
							</h2>
							<br>
							<span style="display: flex;">
								<input class="form-check-input" type="radio" name="role_id" id="role_id1" value="3" checked>
    ...
    <div class="footer_section">
        <div class="container">
            ...
            <p class="long_text">Bergabunglah dengan kami sekarang dan ciptakan kenangan yang tak terlupakan melalui fotografi yang indah </p>
            <div class="footer_section_2">
                <div class="row">
                    <div class="col-sm-12 col-lg-4">
                        <div class="icon_main">
                            <ul>
                                <li><a href="#"><img src="{{ asset('frontend/images/map-icon.png') }}"></a></li>
                                <li><a href="#"><img src="{{ asset('frontend/images/email-icon.png') }}"></a></li>
                                <li><a href="#"><img src="{{ asset('frontend/images/contact-icon.png') }}"></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-12 col-lg-4">
