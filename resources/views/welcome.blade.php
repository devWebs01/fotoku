		...
		<div class="container-fluid">
			<section class="slide-wrapper">
                ...
                <div class="carousel-item">
                   <div class="row">
				       <div class="col-md-7">
					       <div class="images_1"><img src="{{ asset('frontend/images/banner1.jpg') }}"></div>
				        	<div class="banner_main">
					     	    <div class="banner_left">
							        <div class="red_bt"><a href="#">Read More</a></div>
						        </div>
				        ...
				        <div class="col-md-5">
					        <div class="images_2"><img src="{{ asset('frontend/images/img-2.jpg') }}"></div>
				        </div>
			        </div>
                </div>
                <div class="carousel-item">
                   <div class="row">
				       <div class="col-md-7">
					       <div class="images_1"><img src="{{ asset('frontend/images/banner-2.jpg') }}"></div>
				        	<div class="banner_main">
					     	    <div class="banner_left">
							        <div class="red_bt"><a href="#">Read More</a></div>
						        </div>
