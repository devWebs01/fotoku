                ...
                @if (Auth::user()->role->name == 'admin')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.setting.index') }}"
                            class="nav-link {{ request()->routeIs('admin.setting.index') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item child-sidebar">
                                <a href="{{ route('admin.fotografer.index') }}"
                                    class="nav-link {{ request()->is('admin/fotografer*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Fotografer</p>
                                </a>
                            </li>
                            <li class="nav-item child-sidebar">
                                <a href="{{ route('admin.kecamatan.index') }}"
                                    class="nav-link {{ request()->is('admin/kecamatan*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
