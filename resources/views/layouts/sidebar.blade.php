<aside class="main-sidebar sidebar-dark bg-dark elevation-4">
    ...
    <a href="{{ url('/admin/dashboard') }}" class="brand-link text-center">
        ...
        <span class="brand-text font-weight-light font-weight-bold small">eMarketPlace Fotografer</span>
    </a>
    ...
    <div class="sidebar ">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-legacy nav-compact"
                ...
                @if (Auth::user()->role->name == 'admin')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.setting.index') }}"
                            class="nav-link text-white {{ request()->routeIs('admin.setting.index') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.role.index') }}"
                            class="nav-link text-white {{ request()->routeIs('admin.role.index') ? 'active' : '' }}">
                    ...
                    ">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item child-sidebar">
                                <a href="{{ route('admin.fotografer.index') }}"
                                    class="nav-link text-white {{ request()->is('admin/fotografer*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Fotografer</p>
                                </a>
                            </li>
                            <li class="nav-item child-sidebar">
                                <a href="{{ route('admin.kecamatan.index') }}"
                                    class="nav-link text-white {{ request()->is('admin/kecamatan*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.produk.index') }}"
                            class="nav-link text-white {{ request()->is('admin/produk*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.booking.index') }}"
                            class="nav-link text-white {{ request()->is('admin/booking*') ? 'active' : '' }}">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.jadwal.index') }}"
                            class="nav-link text-white {{ request()->is('admin/jadwal*') ? 'active' : '' }}">
                ...
                @if (Auth::user()->role->name == 'fotografer')
                    <li class="nav-item">
                        <a href="{{ route('admin.fotografer.edit', Auth::user()->id) }}"
                            class="nav-link text-white {{ request()->is('admin/fotografer*') ? 'active' : '' }}">
                            <i class="fas fa-cog nav-icon"></i>
                            <p>Edit Profile</p>
                        </a>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.bank.index') }}"
                            class="nav-link text-white {{ request()->is('admin/bank*') ? 'active' : '' }}">
